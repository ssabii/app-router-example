...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className={`
        z-10 w-full max-w-5xl items-center justify-between font-mono text-sm
        lg:flex
      `}>
        <p className={`
          fixed left-0 top-0 flex w-full justify-center border-b border-gray-300 bg-gradient-to-b
        ...
        <div className={`
          fixed bottom-0 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-t
        ...
        `}>
          <a
            className={`
              pointer-events-none flex place-items-center gap-2 p-8
      ...
      <div className={`
        ...
        before:lg:h-[360px] before:dark:bg-gradient-to-br before:dark:from-transparent
      ...
      <div className={`
        mb-32 grid text-center
        lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-4 lg:text-left
      `}>
        <a
